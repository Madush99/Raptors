...
public class settingsAct extends AppCompatActivity
{
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(settingsAct.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        else
        {
            ...
            startActivity(new Intent(settingsAct.this, settingsAct.class));
            finish();
        }
    }
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(settingsAct.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
